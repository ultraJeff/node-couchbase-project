...
class LookupInSpec {
    ...
    static _create(op, path, options) {
        ...
        if (path instanceof LookupInMacro) {
            path = path._value;
            flags |= binding_1.default.lookup_in_path_flag.xattr;
        }
        if (options.xattr) {
            flags |= binding_1.default.lookup_in_path_flag.xattr;
        }
    ...
    static get(path, options) {
        if (!path) {
            return this._create(binding_1.default.subdoc_opcode.get_doc, '', options);
        }
        return this._create(binding_1.default.subdoc_opcode.get, path, options);
    }
    /**
    ...
    static exists(path, options) {
        return this._create(binding_1.default.subdoc_opcode.exists, path, options);
    }
    /**
    ...
    static count(path, options) {
        return this._create(binding_1.default.subdoc_opcode.get_count, path, options);
    }
}
...
class MutateInSpec {
    ...
    static _create(op, path, value, options) {
        ...
        if (value instanceof MutateInMacro) {
            value = value._value;
            flags |= binding_1.default.mutate_in_path_flag.expand_macros;
        }
        if (options.createPath) {
            flags |= binding_1.default.mutate_in_path_flag.create_parents;
        }
        if (options.xattr) {
            flags |= binding_1.default.mutate_in_path_flag.xattr;
        }
        if (value !== undefined) {
    ...
    static insert(path, value, options) {
        return this._create(binding_1.default.subdoc_opcode.dict_add, path, value, options);
    }
    /**
    ...
    static upsert(path, value, options) {
        if (!path) {
            return this._create(binding_1.default.subdoc_opcode.set_doc, '', value, options);
        }
        return this._create(binding_1.default.subdoc_opcode.dict_upsert, path, value, options);
    }
    /**
    ...
    static replace(path, value, options) {
        return this._create(binding_1.default.subdoc_opcode.replace, path, value, options);
    }
    /**
    ...
    static remove(path, options) {
        if (!path) {
            return this._create(binding_1.default.subdoc_opcode.remove_doc, '', undefined, options);
        }
        return this._create(binding_1.default.subdoc_opcode.remove, path, undefined, options);
    }
    /**
    ...
    static arrayAppend(path, value, options) {
        return this._create(binding_1.default.subdoc_opcode.array_push_last, path, value, options);
    }
    /**
    ...
    static arrayPrepend(path, value, options) {
        return this._create(binding_1.default.subdoc_opcode.array_push_first, path, value, options);
    }
    /**
    ...
    static arrayInsert(path, value, options) {
        return this._create(binding_1.default.subdoc_opcode.array_insert, path, value, options);
    }
    /**
    ...
    static arrayAddUnique(path, value, options) {
        return this._create(binding_1.default.subdoc_opcode.array_add_unique, path, value, options);
    }
    /**
    ...
    static increment(path, value, options) {
        return this._create(binding_1.default.subdoc_opcode.counter, path, +value, options);
    }
    /**
