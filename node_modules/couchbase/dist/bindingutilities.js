...
function storeSemanticToCpp(mode) {
    if (mode === null || mode === undefined) {
        return binding_1.default.subdoc_store_semantics_type.replace;
    }
    if (mode === generaltypes_1.StoreSemantics.Insert) {
        return binding_1.default.subdoc_store_semantics_type.insert;
    }
    else if (mode === generaltypes_1.StoreSemantics.Upsert) {
        return binding_1.default.subdoc_store_semantics_type.upsert;
    }
...
function endpointStateFromCpp(service) {
    if (service === binding_1.default.endpoint_state.disconnected) {
        return diagnosticstypes_1.EndpointState.Disconnected;
    }
    else if (service === binding_1.default.endpoint_state.connecting) {
        return diagnosticstypes_1.EndpointState.Connecting;
    }
    else if (service === binding_1.default.endpoint_state.connected) {
        return diagnosticstypes_1.EndpointState.Connected;
    }
    else if (service === binding_1.default.endpoint_state.disconnecting) {
...
function pingStateFromCpp(service) {
    if (service === binding_1.default.ping_state.ok) {
        return diagnosticstypes_1.PingState.Ok;
    }
    else if (service === binding_1.default.ping_state.timeout) {
        return diagnosticstypes_1.PingState.Timeout;
    }
    else if (service === binding_1.default.ping_state.error) {
...
function errorFromCpp(err) {
    ...
    switch (err.code) {
        case binding_1.default.common_errc.request_canceled:
            return new errs.RequestCanceledError(baseErr, context);
        case binding_1.default.common_errc.invalid_argument:
            return new errs.InvalidArgumentError(baseErr, context);
        case binding_1.default.common_errc.service_not_available:
            return new errs.ServiceNotAvailableError(baseErr, context);
        case binding_1.default.common_errc.internal_server_failure:
            return new errs.InternalServerFailureError(baseErr, context);
        case binding_1.default.common_errc.authentication_failure:
            return new errs.AuthenticationFailureError(baseErr, context);
        case binding_1.default.common_errc.temporary_failure:
            return new errs.TemporaryFailureError(baseErr, context);
        case binding_1.default.common_errc.parsing_failure:
            return new errs.ParsingFailureError(baseErr, context);
        case binding_1.default.common_errc.cas_mismatch:
            return new errs.CasMismatchError(baseErr, context);
        case binding_1.default.common_errc.bucket_not_found:
            return new errs.BucketNotFoundError(baseErr, context);
        case binding_1.default.common_errc.collection_not_found:
            return new errs.CollectionNotFoundError(baseErr, context);
        case binding_1.default.common_errc.unsupported_operation:
            return new errs.UnsupportedOperationError(baseErr, context);
        case binding_1.default.common_errc.unambiguous_timeout:
            return new errs.UnambiguousTimeoutError(baseErr, context);
        case binding_1.default.common_errc.ambiguous_timeout:
            return new errs.AmbiguousTimeoutError(baseErr, context);
        case binding_1.default.common_errc.feature_not_available:
            return new errs.FeatureNotAvailableError(baseErr, context);
        case binding_1.default.common_errc.scope_not_found:
            return new errs.ScopeNotFoundError(baseErr, context);
        case binding_1.default.common_errc.index_not_found:
            return new errs.IndexNotFoundError(baseErr, context);
        case binding_1.default.common_errc.index_exists:
            return new errs.IndexExistsError(baseErr, context);
        case binding_1.default.common_errc.decoding_failure:
            return new errs.DecodingFailureError(baseErr, context);
        case binding_1.default.common_errc.rate_limited:
            return new errs.RateLimitedError(baseErr, context);
        case binding_1.default.common_errc.quota_limited:
            return new errs.QuotaLimitedError(baseErr, context);
        case binding_1.default.key_value_errc.document_not_found:
            return new errs.DocumentNotFoundError(baseErr, context);
        case binding_1.default.key_value_errc.document_irretrievable:
            return new errs.DocumentUnretrievableError(baseErr, context);
        case binding_1.default.key_value_errc.document_locked:
            return new errs.DocumentLockedError(baseErr, context);
        case binding_1.default.key_value_errc.value_too_large:
            return new errs.ValueTooLargeError(baseErr, context);
        case binding_1.default.key_value_errc.document_exists:
            return new errs.DocumentExistsError(baseErr, context);
        case binding_1.default.key_value_errc.durability_level_not_available:
            return new errs.DurabilityLevelNotAvailableError(baseErr, context);
        case binding_1.default.key_value_errc.durability_impossible:
            return new errs.DurabilityImpossibleError(baseErr, context);
        case binding_1.default.key_value_errc.durability_ambiguous:
            return new errs.DurabilityAmbiguousError(baseErr, context);
        case binding_1.default.key_value_errc.durable_write_in_progress:
            return new errs.DurableWriteInProgressError(baseErr, context);
        case binding_1.default.key_value_errc.durable_write_re_commit_in_progress:
            return new errs.DurableWriteReCommitInProgressError(baseErr, context);
        case binding_1.default.key_value_errc.path_not_found:
            return new errs.PathNotFoundError(baseErr, context);
        case binding_1.default.key_value_errc.path_mismatch:
            return new errs.PathMismatchError(baseErr, context);
        case binding_1.default.key_value_errc.path_invalid:
            return new errs.PathInvalidError(baseErr, context);
        case binding_1.default.key_value_errc.path_too_big:
            return new errs.PathTooBigError(baseErr, context);
        case binding_1.default.key_value_errc.path_too_deep:
            return new errs.PathTooDeepError(baseErr, context);
        case binding_1.default.key_value_errc.value_too_deep:
            return new errs.ValueTooDeepError(baseErr, context);
        case binding_1.default.key_value_errc.value_invalid:
            return new errs.ValueInvalidError(baseErr, context);
        case binding_1.default.key_value_errc.document_not_json:
            return new errs.DocumentNotJsonError(baseErr, context);
        case binding_1.default.key_value_errc.number_too_big:
            return new errs.NumberTooBigError(baseErr, context);
        case binding_1.default.key_value_errc.delta_invalid:
            return new errs.DeltaInvalidError(baseErr, context);
        case binding_1.default.key_value_errc.path_exists:
            return new errs.PathExistsError(baseErr, context);
        case binding_1.default.key_value_errc.xattr_unknown_macro:
        case binding_1.default.key_value_errc.xattr_invalid_key_combo:
        case binding_1.default.key_value_errc.xattr_unknown_virtual_attribute:
        case binding_1.default.key_value_errc.xattr_cannot_modify_virtual_attribute:
        case binding_1.default.key_value_errc.xattr_no_access:
        case binding_1.default.key_value_errc.cannot_revive_living_document:
            // These error types are converted into generic ones instead.
            break;
        case binding_1.default.query_errc.planning_failure:
            return new errs.PlanningFailureError(baseErr, context);
        case binding_1.default.query_errc.index_failure:
            return new errs.IndexFailureError(baseErr, context);
        case binding_1.default.query_errc.prepared_statement_failure:
            return new errs.PreparedStatementFailureError(baseErr, context);
        case binding_1.default.query_errc.dml_failure:
            return new errs.DmlFailureError(baseErr, context);
        case binding_1.default.analytics_errc.compilation_failure:
            return new errs.CompilationFailureError(baseErr, context);
        case binding_1.default.analytics_errc.job_queue_full:
            return new errs.JobQueueFullError(baseErr, context);
        case binding_1.default.analytics_errc.dataset_not_found:
            return new errs.DatasetNotFoundError(baseErr, context);
        case binding_1.default.analytics_errc.dataverse_not_found:
            return new errs.DataverseNotFoundError(baseErr, context);
        case binding_1.default.analytics_errc.dataset_exists:
            return new errs.DatasetExistsError(baseErr, context);
        case binding_1.default.analytics_errc.dataverse_exists:
            return new errs.DataverseExistsError(baseErr, context);
        case binding_1.default.analytics_errc.link_not_found:
            return new errs.LinkNotFoundError(baseErr, context);
        case binding_1.default.analytics_errc.link_exists:
            return new errs.LinkExistsError(baseErr, context);
        case binding_1.default.search_errc.index_not_ready:
            return new errs.IndexNotReadyError(baseErr, context);
        case binding_1.default.search_errc.consistency_mismatch:
            // These error types are converted into generic ones instead.
            break;
        case binding_1.default.view_errc.view_not_found:
            return new errs.ViewNotFoundError(baseErr, context);
        case binding_1.default.view_errc.design_document_not_found:
            return new errs.DesignDocumentNotFoundError(baseErr, context);
        case binding_1.default.management_errc.collection_exists:
            return new errs.CollectionExistsError(baseErr, context);
        case binding_1.default.management_errc.scope_exists:
            return new errs.ScopeExistsError(baseErr, context);
        case binding_1.default.management_errc.user_not_found:
            return new errs.UserNotFoundError(baseErr, context);
        case binding_1.default.management_errc.group_not_found:
            return new errs.GroupNotFoundError(baseErr, context);
        case binding_1.default.management_errc.bucket_exists:
            return new errs.BucketExistsError(baseErr, context);
        case binding_1.default.management_errc.user_exists:
            return new errs.UserExistsError(baseErr, context);
        case binding_1.default.management_errc.bucket_not_flushable:
            return new errs.BucketNotFlushableError(baseErr, context);
        case binding_1.default.management_errc.eventing_function_not_found:
            return new errs.EventingFunctionNotFoundError(baseErr, context);
        case binding_1.default.management_errc.eventing_function_not_deployed:
            return new errs.EventingFunctionNotDeployedError(baseErr, context);
        case binding_1.default.management_errc.eventing_function_compilation_failure:
            return new errs.EventingFunctionCompilationFailureError(baseErr, context);
        case binding_1.default.management_errc.eventing_function_identical_keyspace:
            return new errs.EventingFunctionIdenticalKeyspaceError(baseErr, context);
        case binding_1.default.management_errc.eventing_function_not_bootstrapped:
            return new errs.EventingFunctionNotBootstrappedError(baseErr, context);
        case binding_1.default.management_errc.eventing_function_deployed:
            return new errs.EventingFunctionDeployedError(baseErr, context);
        case binding_1.default.management_errc.eventing_function_paused:
